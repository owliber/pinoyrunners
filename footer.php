	...
	<?php if( ! is_front_page() && ! is_author() ) : ?>	
		...
		<?php if( wp_is_mobile() ) : ?>
			<div id="footer" class="ui padded vertical footer center aligned segment">
				<a href="<?php echo home_url(); ?>" class="ui middle aligned image"><img title="Pinoy Runners" src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-small-pr.png" /></a>
	    		&copy; Copyright <?php echo CUR_YEAR; ?>
			</div>
		<?php else : ?>
			<div id="footer" class="ui vertical footer segment">
			    <div class="ui three column very stackable grid container">	    	
			    	...
			    	<div class="eight right aligned wide column">
			    		...
			    		&copy; copyright <?php echo CUR_YEAR; ?> &middot; <a href="<?php echo home_url(); ?>">pinoyrunners.co</a> &middot; all rights reserved.
